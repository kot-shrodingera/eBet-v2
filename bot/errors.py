...
class ErrorType(Enum):
    ...
    CANNOT_HANDLE_BET_CREDITS = 505
    ACCOUNT_RESTRICTED = 600
    PLACE_BET_FAILED = 601
    PLACE_BET_LOGOUT = 602
    CHECK_MY_BETS = 603
    CANNOT_PARSE_RESULT_STAKE_VALUE = 604
    PLACE_BET_TRAIDERS_FAILED = 605
    CANNOT_GET_TRAIDERS_RESULT = 606
